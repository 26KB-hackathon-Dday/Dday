 ...
 * 최근 신용점수 이력 응답.
 *
 * <p>{@link #latestScore}·{@link #diffFromPrevious}는 {@code items[0]}과 같은 값이다.
 * 중복이지만, 화면 상단의 "현재 점수"와 아래 그래프는 서로 다른 컴포넌트라
 * 프론트가 빈 배열을 확인하고 첫 원소를 꺼내는 분기를 매번 짜지 않게 서버가 꺼내 둔다.
 *
