...
> Rule 3 단독을 +2 → **+3** 으로 올림 (§7-5 캘리브레이션, 사용자 승인). Rule 5 근사 유지.
...
### 7-4. 실데이터 10건 재채점 (Rule3 단독 +3, T_hi=3, T_lo=0)

| servId | servNm | 사전필터 | R2 | R3 | R4 | R5 | 합 | 결과 |
|---|---|:---:|:--:|:--:|:--:|:--:|:--:|---|
| WLF00004661 | 청년월세 | 통과 | +2 | +3 | 0 | 0 | **5** | AUTO_APPROVED ✅ |
| WLF00000060 | 청년내일저축계좌 | 통과 | 0 | +3 | 0 | 0 | **3** | AUTO_APPROVED ✅ |
| WLF00001076 | 햇살론youth | 통과 | 0 | +3 | 0 | -1 | **2** | REVIEW_QUEUE |
| WLF00004649 | 행복주택 | 통과 | 0 | -2 | -3 | -1 | **-6** | 미저장(제외) ✅ |
| WLF00004663 | 통합공공임대 | DISCARD | | | | | | 미저장 ✅ |
| WLF00000062 | 기존주택등 매입임대 | DISCARD | | | | | | 미저장 ✅ |
| WLF00003277 | 학자금대출 | 통과(jurOrg) | +2 | 0 | 0 | 0 | **2** | REVIEW_QUEUE → 상세서 특례 |
| WLF00003245 | 국민취업지원제도 | 통과 | 0 | -2 | 0 | -1 | **-3** | 미저장(제외) ✅ |
| WLF00003199 | 예술활동준비금 | DISCARD | | | | | | 미저장 ✅ |
| WLF00001063 | 주거안정 월세대출 | DISCARD | | | | | | 미저장 ✅ |

> 결과: 저장 5건 (승인 2, 큐 2, + WLF00000062는 DISCARD) — 실제로 저장은 **청년월세·청년내일저축계좌(승인),
> 햇살론youth·학자금대출(큐)** 4건. 나머지 6건은 DISCARD 또는 제외로 저장 안 됨.
