...
const TYPE_PATHS: Record<PaymentType, string[]> = {
  HEALTH_INSURANCE: ['M12 8.5v7', 'M8.5 12h7'],
  NATIONAL_PENSION: ['M12 5.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13', 'M9.4 11h5.2', 'M9.4 13.4h5.2'],
  TELECOM: ['M6.6 13.4a8 8 0 0 1 10.8 0', 'M9.2 16a4.4 4.4 0 0 1 5.6 0', 'M12 18.4v.1'],
}
</script>
